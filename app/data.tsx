/**
 * This file contains the data for the models that we have available.
 */

/**
 * This is the type of the data that we have for each model.
 */
export type XenositeModelInfo = {
    model: string;
    endpoint: string;
    path: string;
    citation: string;
...
/**
 * This is the list of models that we have available.
 */
