...
export type GenerationMarkerProps = {
  depth: number;
  /** Optional short name beside the generation label. */
  label?: string | null;
  className?: string;
  size?: "sm" | "md";
};
...
/**
 * Compact generation chip (prefer GenerationBanner for section splits).
 */
export default function GenerationMarker({
  ...
  return (
    ...
    >
      <span className="tabular-nums text-gray-600">{gen}</span>
      {label ? (
        <>
